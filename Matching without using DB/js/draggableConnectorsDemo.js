				...
				if (connections.length > 0) {
					...
					jsPlumbDemo.showConnectionInfo(s);
 					       ...
 					       //console.log(connections[k].sourceId + "  and  " +connections[k].targetId );
                                               ...
                                               //console.log(connections[k].getAttachedElements());
...
*/
			...
			//jsPlumb.draggable(divsWithWindowClass);
                        var e1 = jsPlumb.addEndpoint('window1', { anchor:"RightMiddle" }, exampleEndpoint3);
                        //e1.bind("maxConnections", maxConnectionsCallback);
                        var e2 = jsPlumb.addEndpoint('window2', { anchor:"RightMiddle" }, exampleEndpoint3);
                        //e2.bind("maxConnections", maxConnectionsCallback);
                        var e3 = jsPlumb.addEndpoint('window3', { anchor:"LeftMiddle" }, exampleEndpoint4);
                        //e3.bind("maxConnections", maxConnectionsCallback);
                        var e4 = jsPlumb.addEndpoint('window4', { anchor:"LeftMiddle" }, exampleEndpoint4);
                        //e4.bind("maxConnections", maxConnectionsCallback);
